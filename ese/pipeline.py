...
def _role_prompt(
    ...
    *,
    ...
    sections = [
        ...
        _prompt_section("Additional Run Context", additional_context, limit=PROMPT_LIMITS["additional_context"]),
    ]
    sections.extend(
    ...
    sections.append(
        _prompt_section("Operator Feedback", operator_feedback, limit=PROMPT_LIMITS["operator_feedback"])
    )
